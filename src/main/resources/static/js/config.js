    		...
    		if(data[i].pid == 0){
				...
				if(res.type == 0){
					listHtml = $('<div class="f-treeList f-treeListOne">'+
							...
							'<a class="f-treeList-titleP" onclick="'+data[i].click +'" target="rightFrame" href="'+data[i].route +'">'+ data[i].title +'<input hidden="hidden" value="'+data[i].oid+'"></a>'+
							'</div></div></div>');
					};
				if(res.type == 1){
					...
					listHtml = $('<div class="f-treeList f-treeListOne">'+
							...
							radioIconHtml+
							'<input class="id" value="'+ data[i].id +'"/>'+
						    '<input class="deviceID" value="'+ data[i].deviceNumber +'"/>'+//pid
							'</div>'+
							'<div class="f-treeList-titleImg"><span class="f-iconBi"></span></div>'+
							'<a class="f-treeList-titleP" onclick="'+data[i].click +'" target="rightFrame" href="'+data[i].route +'">'+ data[i].title +'<input hidden="hidden" value="'+data[i].oid+'"></a>'+
							'</div></div></div>');
