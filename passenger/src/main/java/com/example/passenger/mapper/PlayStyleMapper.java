...
public interface PlayStyleMapper {
    ...
    List<PlayStyle> selectPaging(@Param("state") Integer state,@Param("name")String name,
                                 @Param("isTemplate")Integer isTemplate,@Param("pageNum") Integer pageNum,
                                 @Param("pageSize") Integer pageSize);

    Integer count(@Param("state") Integer state,@Param("name")String name,
    ...
    Integer updatePlayStyleContent(@Param("id") Integer id,@Param("content") String content);

    Integer deletePlayStyle(Integer id);
