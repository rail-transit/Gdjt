...
public class DevUpkeepController {
    private static final Logger logger = LoggerFactory.getLogger(DevUpkeepController.class);
    ...
    public Map<String, Object> selectDevUpkeep(ModelAndView mv, Integer id,
        ...
        Device device = deviceService.selectDevice(id);
        PageUtil pageUtil = devUpkeepService.selectDevUpkeepByEndTimeNotNull(id, pageNum, 6);
