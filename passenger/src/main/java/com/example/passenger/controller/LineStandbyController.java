...
public class LineStandbyController {
    private static final Logger logger = LoggerFactory.getLogger(LineStandbyController.class);
    ...
    @ResponseBody
    public Map<String, Object> addLineStandby(ModelAndView mv, LineStandby lineStandby, String event, HttpSession session) {
