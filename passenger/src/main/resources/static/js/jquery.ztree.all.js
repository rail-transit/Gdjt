    ...
    view = {
      addNodes: function (setting, parentNode, index, newNodes, isSilent) {
        ...
        if (parentNode) {
          ...
          if (!parentNode.open) {
            view.replaceSwitchClass(parentNode, target_switchObj, consts.folder.CLOSEZD);
            view.replaceIcoClass(parentNode, target_icoObj, consts.folder.CLOSEZD);
      ...
      expandCollapseNode: function (setting, node, expandFlag, animateFlag, callback) {
        ...
        if (isParent) {
          ...
          if (node.open) {
            view.replaceSwitchClass(node, switchObj, consts.folder.OPENDK);
            ...
            view.replaceSwitchClass(node, switchObj, consts.folder.CLOSEZD);
            // view.replaceIcoClass(node, icoObj, consts.folder.CLOSEZD);
      ...
      makeNodeLineClass: function (setting, node) {
        ...
        if (data.nodeIsParent(setting, node)) {
          lineClass.push(node.open ? consts.folder.OPENDK : consts.folder.CLOSEZD);
        } else {
      ...
      replaceIcoClass: function (node, obj, newName) {
        ...
        switch (newName) {
          case consts.folder.OPENDK:
          case consts.folder.CLOSEZD:
  ...
  var _consts = {
    ...
    _view = {
      ...
      makeChkClass: function (setting, node) {
        ...
        var chkName = setting.check.chkStyle + " " + (nodeChecked ? setting.usericon.UNFACHECK : setting.usericon.FACHECKED);
